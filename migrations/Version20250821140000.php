...
/**
 * Unified initial migration: enables PostGIS extensions and creates full baseline schema.
 * NOTE: Apply only on an empty database. If your DB already has the old versions applied,
 * you must drop/recreate the DB or manually insert this version row then skip executing it.
 */
final class Version20250821140000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial unified migration (extensions + full schema)';
    }

    public function up(Schema $schema): void
    {
        // --- Extensions (cannot be inside a transaction) ---
    ...
    {
        // Extension creation / dropping outside transaction.
        return false;
    }
}
